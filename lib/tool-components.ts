...
const componentMap: Record<string, React.ComponentType> = {
  ...
  'pdf-tools/pdf-to-image': dynamic(() => import('@/components/tools/utilities/pdf-to-image').then((m) => m.PdfToImage), { ssr: false }),
  'pdf-tools/image-to-pdf': ImageToPdf,
  'utilities/zip-creator': ZipCreator,
  'pdf-tools/pdf-compressor': PdfCompressor,
  'pdf-tools/pdf-watermark': PdfWatermark,
