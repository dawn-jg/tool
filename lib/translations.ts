// 纯翻译数据文件（server-safe，无 "use client"）
// 供 i18n.tsx（client）和 metadata 生成（server）共用

export const translations = {
  zh: {
    // site
    "site.title": "tooltip.cc",
    "site.subtitle": "免费在线工具箱 · 92+ 实用工具 · 纯浏览器端运行 · 保护隐私安全",
    "nav.home": "首页",
    "nav.allTools": "全部工具",
    ...
    "cat.developerIntro": "无论你是前端、后端还是全栈开发者，日常开发中总少不了各种格式转换、编码解码和数据校验的重复劳动。本分类收录了 19 个开发者高频使用的在线工具，覆盖 JSON 格式化与校验、Base64 / URL / HTML 编解码、正则表达式测试、SQL 格式化、JWT 解码、哈希生成、UUID 生成、YAML 转换、时间戳转换、CSS 可视化生成器（Flexbox、Box-Shadow、Border-Radius、动画）以及 Markdown 预览等场景。所有工具均在浏览器本地执行，不经过网络传输，敏感数据（如 JWT Token、API 响应）不会离开你的设备。",
    "cat.text": "文本处理",
    "cat.textDesc": "文本对比、Markdown编辑、字数统计等文字处理工具",
    "cat.textIntro": "无论是写文档、改文案还是做本地化，文字处理是每个人都会遇到的需求。这个分类提供了 7 个文本处理工具：文本差异对比帮助你快速定位两个版本之间的修改、Markdown 编辑器支持实时预览与导出、大小写转换一键切换 camelCase / snake_case / kebab-case 等命名风格、字数统计精确计算字符数/单词数/行数、Lorem Ipsum 生成器快速产出占位文本、Slug 生成器将中文标题转换为 URL 友好的拼音 slug、全角半角转换解决中英文混排时标点格式不一致的问题。",
    "cat.image": "图片工具",
    "cat.imageDesc": "图片Base64、二维码生成、Favicon生成等图片工具",
    "cat.imageIntro": "图片处理不一定要打开 Photoshop 或下载笨重的桌面软件。这个分类汇集了 9 个纯前端图片工具：图片压缩支持 JPG/PNG/WebP 格式的在线压缩与质量调节、图片转 Base64 将图片文件转换为可直接嵌入 HTML/CSS 的 Data URI、二维码生成器支持自定义尺寸、颜色和容错级别、Favicon 生成器将任意图片转换为网站图标、占位图生成器可按尺寸/颜色/文字生成占位图片、渐变色生成器提供拖拽调色与 CSS 代码导出，以及 Meme 生成器和海报生成器。所有操作在浏览器中完成，图片不会上传到服务器。",
    "cat.data": "数据工具",
    "cat.dataDesc": "密码生成、Cron表达式、进制转换等数据处理工具",
    "cat.dataIntro": "数据工具是开发与运维场景中的效率倍增器。本分类涵盖随机密码生成器（支持长度、字符集自定义）、Cron 表达式生成器（可视化选择分钟/小时/日/月/周，自动生成标准 cron 语法）、进制转换器（二进制/八进制/十进制/十六进制互转）等 3 个核心工具。所有计算在浏览器本地完成，生成的密码不会被记录或传输。",
    "cat.generators": "生成器",
    "cat.generatorsDesc": "占位图、假数据、渐变色等实用生成工具",
    "cat.generatorsIntro": "开发项目时经常需要各种辅助素材——占位图片、填充数据、测试文本、渐变色方案、Lorem Ipsum 段落等。这个分类汇集了 8 个在线生成工具：占位图生成器支持自定义尺寸与颜色、Lorem Ipsum 生成器产出指定长度的假文、渐变色生成器提供可视化调色与 CSS 代码复制、假数据生成器模拟姓名/邮箱/地址等测试数据、密码生成器一键生成高强度随机密码、UUID 生成器创建唯一标识符等。需要什么，打开就生成，用完即走。",
    "cat.validators": "验证器",
    "cat.validatorsDesc": "邮箱、手机号、身份证等格式验证工具",
    "cat.validatorsIntro": "数据验证是开发中最容易出错也最耗时的环节。验证器分类收录了 9 个格式验证工具：邮箱格式校验、手机号验证、身份证号码校验（含校验位计算）、URL 合法性检查、IP 地址验证、颜色格式校验、信用卡号 Luhn 算法验证、中国统一社会信用代码校验、ISBN 书号验证。所有验证在浏览器本地执行，输入的内容不会被发送到任何服务器。批量验证时，每个输入独立处理，不会互相干扰。",
    "cat.pdf": "PDF 工具",
    "cat.pdfDesc": "PDF合并、拆分、压缩、加水印、转图片等 PDF 处理工具",
    "cat.pdfIntro": "PDF 是日常办公与文档分发中使用最频繁的格式之一。这个分类汇集了 5 个纯前端 PDF 处理工具：PDF 合并与拆分支持自由组合页面、PDF 压缩帮助减小文件体积便于分享、PDF 加水印支持文字水印保护文档、PDF 转图片将页面导出为 PNG/JPG、图片转 PDF 把多张图片合成一个文档。所有处理均在浏览器本地完成，文件不会上传到服务器，隐私安全有保障。",
    "cat.utilities": "实用工具",
    "cat.utilitiesDesc": "单位换算、计时器、计算器等日常生活工具",
    "cat.utilitiesIntro": "工具站最大的分类，收录了 17 个覆盖办公与生活场景的实用工具。包括科学计算器、房贷计算器（等额本息/等额本金）、单位换算器、番茄钟计时器、EXIF 信息查看器、视频下载器（支持 B 站/TikTok 等多平台）、文本转海报、短链接生成器、ZIP 压缩包创建、温度转换器、二维码解码器、颜色提取器、谚语词典等。大部分工具支持中英文双语切换，所有操作在浏览器本地完成。",
    "cat.network": "网络工具",
    "cat.networkDesc": "IP查询、DNS查询、延迟测试、HTTP头查看等网络相关工具",
    "cat.networkIntro": "网络诊断与信息查询是运维和开发中的高频需求。本分类包含 5 个网络工具：IP 信息查询（通过 RDAP 协议获取 IP 归属地/运营商等信息）、DNS 记录查询（A/AAAA/MX/NS/TXT/CNAME 等多种记录类型）、网络延迟测试（Ping 多个目标地址并显示响应时间）、HTTP 头查看器（展示任意 URL 的响应头信息）以及域名信息查询（通过 RDAP 获取域名注册商/注册时间/DNS 服务器等 WHOIS 信息）。",
    "cat.fun": "趣味工具",
    "cat.funDesc": "MBTI人格测试、SBTI测试等趣味实用工具",
    "cat.funIntro": "工作之余也需要一点轻松。趣味工具分类收录了 MBTI 人格测试（20 题完整版，涵盖 16 种人格类型，附带详细解读）和 SBTI 社交行为测试（原创评测，分析社交风格与互动模式）等趣味实用工具。所有测试纯前端执行，不会收集任何答题数据。更多好玩的工具正在开发中。",
  ...
  "tool.jsonFormatter.instructions": "粘贴JSON数据，点击格式化美化排版，或点击压缩去除多余空格。支持校验JSON语法合法性。所有处理均在浏览器本地完成，数据不会上传。",
    ...
    "tool.imageConverter": "图片格式转换",
    "tool.imageConverterDesc": "在线转换图片格式，PNG/JPG/WebP/AVIF/BMP/GIF 互转，支持批量处理，纯浏览器本地转换",
    "tool.jsonXmlConverter": "JSON ↔ XML 转换",
    "tool.jsonXmlConverterDesc": "在线 JSON 与 XML 互转，支持嵌套对象、数组、属性，纯浏览器本地转换",
    "tool.csvSplitter": "CSV 拆分工具",
    "tool.csvSplitterDesc": "在线拆分 CSV 文件，支持按行数拆分和按列分组拆分，保留表头，纯浏览器处理",
    "tool.imageCropper": "图片裁剪工具",
    "tool.imageCropperDesc": "在线裁剪图片，支持自由裁剪和 1:1、4:3、16:9 等比例，拖拽调整选区，纯浏览器处理",
    "tool.imageWatermark": "图片加水印",
    "tool.imageWatermarkDesc": "在线给图片添加文字或图片水印，支持位置、透明度、平铺设置，纯浏览器处理",
    "tool.circleAvatar": "圆形头像生成",
    "tool.circleAvatarDesc": "在线将图片裁剪为圆形头像，支持自定义尺寸、透明或纯色背景，纯浏览器处理",
    "tool.videoToGif": "视频转 GIF",
    "tool.videoToGifDesc": "在线将视频转换为 GIF 动图，支持 MP4/WebM 等格式，可选质量，浏览器本地处理",
    "tool.pdfToImage": "PDF 转图片",
    "tool.pdfToImageDesc": "在线将 PDF 每页转为 PNG/JPG 图片，支持高清导出和 ZIP 打包下载，纯浏览器处理",
    "tool.imageToPdf": "图片转 PDF",
    "tool.imageToPdfDesc": "在线将多张图片合成一个 PDF，支持 PNG/JPG/WebP/GIF，可调页面尺寸和顺序，纯浏览器处理",
    "tool.zipCreator": "创建 ZIP 压缩包",
    "tool.zipCreatorDesc": "在线创建 ZIP 压缩文件，支持多文件、文本文件、压缩级别选择，纯浏览器处理",
    "tool.pdfCompressor": "PDF 压缩",
    "tool.pdfCompressorDesc": "在线压缩 PDF 文件，去除冗余数据、优化结构减小体积，显示压缩前后对比，纯浏览器处理",
    "tool.pdfWatermark": "PDF 加水印",
    "tool.pdfWatermarkDesc": "在线给 PDF 添加文字水印，支持居中、顶部、底部和平铺斜纹模式，纯浏览器处理",
    ...
    "tool.videoDownloader": "短视频下载",
    "tool.videoDownloaderDesc": "输入B站/TikTok/抖音等短视频链接，解析并获取高清下载",
  ...
  "tool.speedTest": "网速测试",
  "tool.speedTestDesc": "在线测试网络下载、上传速度和延迟，基于 Ookla Speedtest 测速节点",
  "tool.speedTestInstructions": "点击开始测速，将依次测试延迟/抖动、下载速度和上传速度。测速基于 Ookla Speedtest 全球测速节点（优先选择附近节点），结果贴近运营商实际带宽。测速过程约 30 秒，请保持网络稳定。",
  "tool.speedTestDownload": "下载速度",
  "tool.speedTestUpload": "上传速度",
  "tool.speedTestPing": "延迟",
  "tool.speedTestJitter": "抖动",
  "tool.speedTestStart": "开始测速",
  "tool.speedTestStop": "停止",
  "tool.speedTestRestart": "重新测速",
  "tool.speedTestReady": "准备就绪",
  "tool.speedTestDone": "测试完成",
  "tool.speedTestAborted": "已中止",
  "tool.speedTestLoading": "加载中...",
  "tool.speedTestTesting": "测速中...",
  "tool.speedTestPhase0": "准备中...",
  "tool.speedTestPhase1": "下载测速中...",
  "tool.speedTestPhase2": "延迟/抖动测试中...",
  "tool.speedTestPhase3": "上传测速中...",
  "tool.speedTestPhase4": "测试完成",
  "tool.speedTestPhase5": "已中止",
  "tool.speedTestLoadError": "测速引擎加载失败，请刷新重试",
  "tool.speedTestEngineError": "测速引擎初始化失败，请刷新页面重试",
  "tool.speedTestFooter": "测速基于 Ookla Speedtest 测速节点，结果反映你的实际宽带水平。",
  "tool.speedTestServer": "测速节点",
  "tool.speedTestNoServer": "暂时无法获取测速节点，请刷新重试",
  ...
  en: {
    // site
    "site.title": "tooltip.cc",
    "site.subtitle": "Free Online Tools · 92+ Tools · Browser-only · Privacy Focused",
    "nav.home": "Home",
    ...
    "cat.developerIntro": "Whether you're a frontend, backend, or full-stack developer, repetitive format conversions, encoding/decoding, and data validation tasks are part of your daily routine. This category includes 19 high-frequency developer tools, covering JSON formatting & validation, Base64/URL/HTML encoding/decoding, regex testing, SQL formatting, JWT decoding, hash generation (MD5/SHA), UUID generation, YAML conversion, timestamp conversion, CSS visual generators (Flexbox, Box-Shadow, Border-Radius, CSS Animation), and Markdown preview. All tools run locally in your browser — no data ever leaves your device.",
    "cat.text": "Text Tools",
    "cat.textDesc": "Text diff, Markdown editor, Word counter and more",
    "cat.textIntro": "Whether you're writing documentation, editing copy, or doing localization, text processing is a universal need. This category includes 7 text tools: Text Diff for quickly identifying changes between two versions, Markdown Editor with real-time preview and export, Case Converter for switching between camelCase/snake_case/kebab-case, Word Counter with precise character/word/line counts, Lorem Ipsum generator for placeholder text, Slug Generator for converting Chinese titles to URL-friendly pinyin slugs, and Full-width/Half-width converter for fixing punctuation formatting in mixed Chinese-English text.",
    "cat.image": "Image Tools",
    "cat.imageDesc": "Image to Base64, QR code generator, Favicon generator and more",
    "cat.imageIntro": "Image processing doesn't require Photoshop or bulky desktop software. This category includes 9 pure frontend image tools: Image Compressor for online compression of JPG/PNG/WebP with quality adjustment, Image to Base64 for converting images to Data URIs, QR Code Generator with customizable size/color/error correction, Favicon Generator for converting any image to a site icon, Placeholder Image Generator with custom size/color/text, Gradient Generator with drag-and-drop color picker and CSS export, plus Meme Generator and Poster Generator. All operations are performed in the browser — images are never uploaded.",
    "cat.data": "Data Tools",
    "cat.dataDesc": "Password generator, Cron expression, Base converter and more",
    "cat.dataIntro": "Data tools are efficiency multipliers for development and operations. This category includes Random Password Generator (with customizable length and character sets), Cron Expression Generator (visual UI for selecting minute/hour/day/month/weekday, auto-generating standard cron syntax), and Base Converter (binary/octal/decimal/hexadecimal conversion). All computations run locally — generated passwords are never recorded or transmitted.",
    "cat.generators": "Generators",
    "cat.generatorsDesc": "Placeholder image, Fake data, Color gradient and more",
    "cat.generatorsIntro": "Development projects often need auxiliary assets — placeholder images, filler data, test text, gradient color schemes, Lorem Ipsum paragraphs, etc. This category includes 8 online generators: Placeholder Image Generator with custom size and color, Lorem Ipsum Generator for producing specified-length dummy text, Gradient Generator with visual color picking and CSS code copying, Fake Data Generator for simulating names/emails/addresses, Password Generator for high-strength random passwords, UUID Generator for unique identifiers, and more.",
    "cat.validators": "Validators",
    "cat.validatorsDesc": "Email, Phone, ID card format validation and more",
    "cat.validatorsIntro": "Data validation is one of the most error-prone and time-consuming aspects of development. This category includes 9 format validators: Email format validation, Phone number validation, ID card number validation (including checksum calculation), URL validity check, IP address validation, Color format validation, Credit card Luhn algorithm validation, China Unified Social Credit Code validation, and ISBN book number validation. All validation runs locally — input is never sent to any server. Batch validation processes each input independently without interference.",
    "cat.pdf": "PDF Tools",
    "cat.pdfDesc": "Merge, split, compress, watermark, convert PDF files",
    "cat.pdfIntro": "PDF is one of the most frequently used formats in daily office work and document sharing. This category collects 5 pure front-end PDF tools: PDF merge and split, PDF compression to reduce file size, PDF watermarking for document protection, PDF to image conversion, and image to PDF conversion. All processing happens locally in your browser - files never leave your device.",
    "cat.utilities": "Utilities",
    "cat.utilitiesDesc": "Unit converter, Countdown, World clock and more",
    "cat.utilitiesIntro": "The largest category on the site, with 17 tools covering work and everyday scenarios. Includes Scientific Calculator, Mortgage Calculator (equal installments / equal principal), Unit Converter, Pomodoro Timer, EXIF Viewer, Video Downloader (supporting Bilibili, TikTok, and more), Text-to-Poster, Short Link Generator, ZIP Archive Creator, Temperature Converter, QR Code Decoder, Color Extractor, Proverb Dictionary, and more. Most tools support bilingual Chinese/English switching. All operations run locally in the browser.",
    "cat.network": "Network Tools",
    "cat.networkDesc": "IP lookup, DNS query, latency test, HTTP headers and more",
    "cat.networkIntro": "Network diagnostics and information lookup are high-frequency needs in operations and development. This category includes 5 network tools: IP Information Lookup (retrieving IP geolocation/ISP via RDAP protocol), DNS Record Query (A/AAAA/MX/NS/TXT/CNAME record types), Network Latency Test (pinging multiple targets and displaying response times), HTTP Header Viewer (showing response headers for any URL), and Domain Information Lookup (retrieving registrar/registration date/DNS servers via RDAP).",
    "cat.fun": "Fun Tools",
    "cat.funDesc": "MBTI personality test, SBTI test and more fun tools",
    "cat.funIntro": "A little fun between work sessions. This category features the MBTI Personality Test (20-question full version, covering all 16 personality types with detailed interpretations) and the SBTI Social Behavior Test (an original assessment analyzing social styles and interaction patterns). All tests run entirely in the browser — no response data is collected. More fun tools are in development.",
  ...
  "tool.jsonFormatter.instructions": "Paste JSON data, click Format to beautify, or click Minify to remove extra whitespace. Validation checks JSON syntax. All processing happens locally in your browser - nothing is uploaded.",
    ...
    "tool.imageConverterDesc": "Convert image formats online: PNG/JPG/WebP/AVIF/BMP/GIF, batch convert, 100% client-side",
    "tool.jsonXmlConverter": "JSON ↔ XML Converter",
    "tool.jsonXmlConverterDesc": "Convert JSON to XML and XML to JSON online, supports nested objects, arrays, attributes, 100% client-side",
    "tool.csvSplitter": "CSV Splitter",
    "tool.csvSplitterDesc": "Split CSV files online by row count or column groups, keep headers, 100% client-side",
    "tool.imageCropper": "Image Cropper",
    "tool.imageCropperDesc": "Crop images online with free or preset ratios (1:1, 4:3, 16:9), drag to adjust, 100% client-side",
    "tool.imageWatermark": "Image Watermark",
    "tool.imageWatermarkDesc": "Add text or image watermarks online, adjust position, opacity and tiling, 100% client-side",
    "tool.circleAvatar": "Circle Avatar Maker",
    "tool.circleAvatarDesc": "Crop images into circular avatars online, custom size, transparent or solid background, 100% client-side",
    "tool.videoToGif": "Video to GIF",
    "tool.videoToGifDesc": "Convert videos to GIF online, supports MP4/WebM, quality options, processed locally in browser",
    "tool.pdfToImage": "PDF to Image",
    "tool.pdfToImageDesc": "Convert PDF pages to PNG/JPG images online, high-res export and ZIP download, 100% client-side",
    "tool.imageToPdf": "Image to PDF",
    "tool.imageToPdfDesc": "Combine multiple images into one PDF online, supports PNG/JPG/WebP/GIF, adjust page size and order, 100% client-side",
    "tool.zipCreator": "ZIP Creator",
    "tool.zipCreatorDesc": "Create ZIP archives online, multiple files, text files, compression level options, 100% client-side",
    "tool.pdfCompressor": "PDF Compressor",
    "tool.pdfCompressorDesc": "Compress PDF files online, remove redundant data and optimize structure, compare sizes, 100% client-side",
    "tool.pdfWatermark": "PDF Watermark",
    "tool.pdfWatermarkDesc": "Add text watermarks to PDF online, center/top/bottom/tiled diagonal modes, 100% client-side",
    ...
    "tool.videoDownloader": "Video Downloader",
    "tool.videoDownloaderDesc": "Extract and download HD videos from Bilibili/TikTok/Douyin links",
  ...
  "tool.speedTest": "Speed Test",
  "tool.speedTestDesc": "Test your network download, upload speed and latency with Ookla Speedtest servers",
  "tool.speedTestInstructions": "Click start to test latency/jitter, download speed and upload speed in sequence. Based on Ookla Speedtest global servers (nearby nodes preferred), results reflect your real ISP bandwidth. The test takes about 30 seconds, please keep your network stable.",
  "tool.speedTestDownload": "Download",
  "tool.speedTestUpload": "Upload",
  "tool.speedTestPing": "Ping",
  "tool.speedTestJitter": "Jitter",
  "tool.speedTestStart": "Start Test",
  "tool.speedTestStop": "Stop",
  "tool.speedTestRestart": "Test Again",
  "tool.speedTestReady": "Ready",
  "tool.speedTestDone": "Test Complete",
  "tool.speedTestAborted": "Aborted",
  "tool.speedTestLoading": "Loading...",
  "tool.speedTestTesting": "Testing...",
  "tool.speedTestPhase0": "Starting...",
  "tool.speedTestPhase1": "Testing download...",
  "tool.speedTestPhase2": "Testing latency/jitter...",
  "tool.speedTestPhase3": "Testing upload...",
  "tool.speedTestPhase4": "Test Complete",
  "tool.speedTestPhase5": "Aborted",
  "tool.speedTestLoadError": "Failed to load speed test engine, please refresh",
  "tool.speedTestEngineError": "Speed test engine initialization failed, please refresh and retry",
  "tool.speedTestFooter": "Powered by Ookla Speedtest servers. Results reflect your real bandwidth.",
  "tool.speedTestServer": "Server",
  "tool.speedTestNoServer": "Failed to load speed test servers, please refresh",
