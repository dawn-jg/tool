...
export const translations = {
  zh: {
    ...
    "cat.utilitiesIntro": "工具站最大的分类，收录了 16 个覆盖办公与生活场景的实用工具。包括科学计算器、房贷计算器（等额本息/等额本金）、单位换算器、番茄钟计时器、EXIF 信息查看器、PDF 处理工具（合并/拆分/压缩）、视频下载器（支持 B 站/TikTok 等多平台）、文本转海报、短链接生成器、温度转换器、二维码解码器、颜色提取器、谚语词典等。大部分工具支持中英文双语切换，所有操作在浏览器本地完成。",
    "cat.network": "网络工具",
  ...
  en: {
    ...
    "cat.utilitiesIntro": "The largest category on the site, with 16 tools covering work and everyday scenarios. Includes Scientific Calculator, Mortgage Calculator (equal installments / equal principal), Unit Converter, Pomodoro Timer, EXIF Viewer, PDF Tools (merge/split/compress), Video Downloader (supporting Bilibili, TikTok, and more), Text-to-Poster, Short Link Generator, Temperature Converter, QR Code Decoder, Color Extractor, Proverb Dictionary, and more. Most tools support bilingual Chinese/English switching. All operations run locally in the browser.",
