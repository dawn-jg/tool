...
export const translations = {
  ...
  "tool.speedTestFooter": "测速通过 Cloudflare 官方测速服务进行，结果仅反映你与 Cloudflare 边缘节点的连接质量，不代表运营商宽带峰值。",
  ...
  "tool.speedTestFooter": "Speed test via Cloudflare official service. Results reflect your connection to Cloudflare edge nodes, not your ISP peak bandwidth.",
