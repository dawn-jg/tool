...
export const translations = {
  ...
  "tool.speedTest": "网速测试",
  "tool.speedTestDesc": "在线测试网络下载、上传速度和延迟，通过 Cloudflare 全球边缘节点",
  "tool.speedTestInstructions": "点击开始测速，将依次测试下载速度、延迟/抖动和上传速度。测速数据通过 Cloudflare 全球边缘节点传输，结果反映你到最近边缘节点的网络质量。测速过程约 30 秒，请保持网络稳定。",
  ...
  "tool.speedTestFooter": "测速引擎由 LibreSpeed (GNU LGPLv3) 驱动 · 数据通过 Cloudflare 官方测速服务传输。结果仅反映你与 Cloudflare 边缘节点的连接质量，不代表运营商宽带峰值。",
  "tool.speedTestOfficial": "直接使用官方测速站",
  "tool.speedTestOfficialDesc": "如果站内测速无响应或想对比结果，可直接打开官方测速页面测速",
  "tool.speedTestOfficialCf": "Cloudflare 官方测速",
  "tool.speedTestOfficialOokla": "Ookla Speedtest",
  ...
  "tool.speedTestDesc": "Test your network download, upload speed and latency via Cloudflare edge nodes",
  "tool.speedTestInstructions": "Click start to test download speed, latency/jitter and upload speed. Data is transferred via Cloudflare global edge nodes, reflecting your connection quality to the nearest edge node. The test takes about 30 seconds, please keep your network stable.",
  ...
  "tool.speedTestFooter": "Powered by LibreSpeed (GNU LGPLv3) · Data via Cloudflare official speed test service. Results reflect your connection to Cloudflare edge nodes, not your ISP peak bandwidth.",
  "tool.speedTestOfficial": "Use Official Speed Test",
  "tool.speedTestOfficialDesc": "If the in-page test doesn't respond or you want to compare, open the official speed test page directly",
  "tool.speedTestOfficialCf": "Cloudflare Speed Test",
  "tool.speedTestOfficialOokla": "Ookla Speedtest",
